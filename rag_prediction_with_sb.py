...
from src.prompt_utils import tokens_counter, prompt_cost
from src.llm_client import call_openai_model 
...
results.to_csv('output/predictions/rag_sb1.csv', sep=";", index=False)
print('results ready!')